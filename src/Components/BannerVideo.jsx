...
function BannerVideo() {
  ...
  return (
    <>
      <section className="bg-[#FAFAFA] relative pt-1 justify-center">
      ...
      <section className="flex justify-center w-full">
        <div className="w-full max-w-7xl">
          <section className="mt-8 sm:mt-10 md:mt-16 lg:mt-21">
            ...
            <div className="mt-8 sm:mt-10 md:mt-12 lg:mt-15 w-70% sm:w-[90%] md:w-[80%] lg:w-280 mx-4 sm:mx-6 md:mx-auto lg:ml-28">
              <img src={Rectangle4} alt="" className="w-full object-cover" />
            </div>

            <div className="relative md:absolute w-[90%] sm:w-[80%] md:w-[70%] lg:w-[700px] h-auto lg:h-50 mx-auto sm:mx-6 md:ml-[15%] sm:ml-[9%] lg:ml-78 bg-[#FAFAFA] rounded-3xl mt-[-50px] sm:mt-[-75px] md:mt-[-100px] lg:mt-[-150px]">
            ...
            {/* ........Gym center start........... */}
            <div className="mt-16 sm:mt-18 md:mt-20 lg:mt-28 w-70% sm:w-[90%] md:w-[80%] lg:w-280 mx-4 sm:mx-6 md:mx-auto lg:mx-auto lg:ml-28">
            ...
            <div className="relative md:absolute w-[90%] sm:w-[80%] md:w-[70%] lg:w-[700px] h-auto lg:h-50 mx-auto sm:mx-6 sm:ml-[9%] md:ml-[15%] lg:ml-78 bg-[#FAFAFA] rounded-3xl mt-[-50px] sm:mt-[-75px] md:mt-[-100px] lg:mt-[-150px]">
              <span className="w-full lg:w-[700px] h-[20px] bg-[#7C6A46] rounded-t-4xl snap-center flex items-center mb-3 sm:mb-4 lg:mb-5"></span>
              <h1 className="text-center mb-3 sm:mb-4 lg:mb-5 text-lg sm:text-xl md:text-2xl text-[#7C6A46]">
                Restaurant
              </h1>
              <p className="text-center w-[80%] sm:w-[85%] md:w-[80%] lg:w-155 mx-auto lg:ml-10 text-xs sm:text-sm md:text-base pb-4 sm:pb-3 lg:pb-0">
                The elegant luxury bedrooms in this gallery showcase custom interior designs & decorating ideas. View pictures and find your perfect luxury bedroom design. Luxurious bedrooms that will make you never want to leave your room again. See more ideas about luxurious bedrooms, bedroom design
              </p>
            </div>
            {/* ........Restaurant End...... */}
